...
public class MTB_K3S2 extends RoutingProfile {

    public MTB_K3S2( ) {
        super(new CostCalcSplineProfileMTB( new CostCalcSplineProfileMTB.Context(300,200) ));
    }
    ...
    public int getIconIdActive() {
         return R.drawable.rp_mtb_k3s2_a;
    }

    @Override
    protected int getIconIdInactive() {
        return R.drawable.rp_mtb_k3s2_i;
    }
    protected int getIconIdCalculating() {
        return R.drawable.rp_mtb_k3s2_c;
    }
