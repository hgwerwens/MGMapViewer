...
public class MTB_K3S3_Spline extends RoutingProfile {
    public MTB_K3S3_Spline( ) {
        super(new CostCalcSplineProfileMTB( new CostCalcSplineProfileMTB.Context(300,300) ));
    }
