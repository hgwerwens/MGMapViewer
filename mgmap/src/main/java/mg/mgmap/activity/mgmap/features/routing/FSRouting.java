...
import mg.mgmap.activity.mgmap.features.routing.profile.MTB_K1S1_Spline;
...
import mg.mgmap.activity.mgmap.features.routing.profile.MTB_K2S1_Spline;
...
import mg.mgmap.activity.mgmap.features.routing.profile.MTB_K3S3_Spline;
...
//    private final Pref<Boolean> prefStlVisibility = getPref(R.string.FSATL_pref_STL_visibility, false);
    ...
    public FSRouting(MGMapActivity mgActivity, FSMarker fsMarker, GGraphTileFactory gFactory) {
        ...
        addDefinedRoutingProfile(prefCache, new MTB_K1S1_Spline(), false);
        ...
        addDefinedRoutingProfile(prefCache, new MTB_K2S1_Spline(), false);
        addDefinedRoutingProfile(prefCache, new MTB_K2S2(), true);
        addDefinedRoutingProfile(prefCache, new MTB_K2S2_Spline(), false);
        ...
        addDefinedRoutingProfile(prefCache, new MTB_K3S3_Spline(), false);
